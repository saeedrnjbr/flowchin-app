...
export default memo(({ data }) => {
    ...
    return <>
        ...
        {meta.input == 1 && <Handle isConnectableStart={false} type="target" position={Position.Top} className='flex items-center justify-center text-stone-600  text-sm'></Handle>}
        <div className=" noding rounded-xl " style={{ borderColor: meta.colors[meta.background][100] }}>
